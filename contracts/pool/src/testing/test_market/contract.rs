use axis::market::{ExecuteMsg, InstantiateMsg, QueryMsg};
use axis::pool::ExecuteMsg as PoolExecuteMsg;
use axis::treasury::ExecuteMsg as TreasuryExecuteMsg;
use axis::vault::ExecuteMsg as VaultExecuteMsg;
...
pub mod query {
    use axis::market::{GetConfigResponse, GetFeeConfigResponse, TradeResponse};
